...
import { Form, Image, Offcanvas, Button, FloatingLabel, Row } from "react-bootstrap"
                ...
                <Offcanvas.Body className="pt-0">
                    <Form onSubmit={(e) => updateUser(e)}>
                        <Form.Group className="mb-2">
                            ...
                            <Image
                                src={
                                    imageFile
                                        ...
                                        : user?.avatar || "https://via.placeholder.com/600x600?text=Blog+Image"
                                }
                                height="200px"
                                // width="400px"
                                alt="cover"
                            ...
                            />
                            <Row className="mx-5">
                            <Button variant="dark" className="" onClick={() => fileInputRef.current?.click()}>
                                Upload Image
                            </Button>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <FloatingLabel controlId="floatingSelect" label="Role">
                                <Form.Select aria-label="Floating label select example" value={user.role} onChange={e => setUser({ ...user, role: e.currentTarget.value })}>
